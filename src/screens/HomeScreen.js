...
import { View, Text, FlatList, TouchableOpacity, TextInput, StyleSheet, Image, ScrollView, Alert } from 'react-native';
...
const HomeScreen = ({ navigation }) => {
  ...
  const handleAddItem = async () => {
    ...
    description: "Mengelola pabrik Susu Tetangga memang tidaklah mudah. Malik dan Cherryn yang mendapat tantangan dari kedua orang tuanya harus memutar otak agar bisa memenuhi permintaan itu. Apalagi saat orang tua Malik tiba-tiba mengumumkan perjodohan mereka berdua. Cherryn, si gadis cantik nan garang yang selalu kesal dengan kehadiran Malik si cowok bertubuh tambun—tapi mirip artis Korea—harus belajar akrab demi memajukan perusahaan dan kisah cinta mereka.“Om sudah berjanji akan menjodohkan kamu dengan anak om, Cherryn.” “Hah? Dijodohin? Sama anak Om yang mana?” “Anak om cuma satu, Cherryn, yaitu Malik.” “Hah? Cherryn? Sama si Milk Shake dijodohin?”",
    rating:4.6,
